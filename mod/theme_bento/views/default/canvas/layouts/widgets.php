...
<div id="customise_editpanel" class="grid_16 alpha omega box box-shadow box-settings">

  <div class="customise-editpanel-instructions grid_12 alpha">
    <h2><?php echo elgg_echo('widgets:add'); ?></h2>
    <?php echo elgg_view('output/longtext', array('value' => elgg_echo('widgets:add:description'))); ?>
  </div>

  <div id="customise_page_view" class="grid_12 alpha ">
  ...
  <tr>
    <td>
      ...
      <table class="draggable_widget" cellspacing="0"><tr><td width="">
        <h3>
  ...
  <!-- Original Position of Form -->

  </div><!-- /#customise_page_view -->



<div id="customise_editpanel_rhs" class="grid_4 box omega">
<h2 class="box-header top-zero"><?php echo elgg_echo("widgets:gallery"); ?></h2>
...
<td width="17px" align="right"></td>
<td width="17px" align="right"><a class="more-info" href="#"><img src="<?php echo $vars['url']; ?>_graphics/spacer.gif" width="14px" height="14px" class="more_info" /></a></td>
<td width="17px" align="right"><a class="drag-handle" href="#"><img src="<?php echo $vars['url']; ?>_graphics/spacer.gif" width="15px" height="15px" class="drag_handle" /></a></td>
</tr></table>
...
<div class="grid_16 clearfix aligncenter">
  ...
  <input type="submit" value="<?php echo elgg_echo('save'); ?>" class="submit_button button" onclick="$('a.toggle_customise_edit_panel').click();" />
  <input type="button" value="<?php echo elgg_echo('cancel'); ?>" class="cancel_button button" onclick="$('a.toggle_customise_edit_panel').click();" />
