	...
	if ($choices) {
		foreach($choices as $choice) {
			...
			/*$body .= elgg_view('input/hidden',
				array(	'internalname'	=>	'choice_display_order_'.$i,
						'value' 		=> 	$choice->display_order
				)
			);
			$body .= elgg_view('input/hidden',
				array(	'internalname'	=>	'choice_guid_'.$i,
						'value' 		=> 	$choice->guid
				)
			);*/
			$body .= elgg_view('input/text',
				array(	'internalname'	=>	'choice_text_'.$i,
						'value' 		=> 	$choice->text,
...
$body .= elgg_view('input/hidden',
	array(	'internalname'	=>	'number_of_choices',
			'internalid'	=>	'number_of_choices',
			'value' 		=> 	$i
	)
);
