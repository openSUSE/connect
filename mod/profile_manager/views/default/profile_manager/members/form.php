<?php 
	...
	$default_search_criteria .= elgg_view("input/radio", array("internalname" => "sorting", "value" => $input_sorting, "options" => array(elgg_echo("alphabetic") => "alphabetic", elgg_echo("newest") => "newest", elgg_echo("popular") => "popular", elgg_echo("online") => "online")));
