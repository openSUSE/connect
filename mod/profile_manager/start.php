<?php 
	...
	*/
	...
	function profile_manager_page_handler($page){
		...
		switch($page[0]){
			case "group_fields":
				include(dirname(__FILE__) . "/group_fields.php");
				break;
			case "profile_fields":
			...
			case "full_profile":
				...
				include(dirname(__FILE__) . "/full_profile.php");
				break;
			case "export":
	...
	// profile edit overrule
	if(version_compare(get_version(true), "1.7", ">=")){ 
		register_action("profile/edit",false,$CONFIG->pluginspath . "profile_manager/actions/profile/edit.php");
	}
