<?php
	...
	$english = array(
			...
			'custom:polls' => "Latest polls",
			'custom:members' => "Newest members",
			'custom:events' => "Latest events",
			'custom:nofiles' => "There are no files yet",
			'custom:nogroups' => "There are no groups yet",
			'custom:nousers' => "There are no users yet",
			'custom:nopolls' => "There are no polls yet",
			'custom:noevents' => "There are no events yet",
