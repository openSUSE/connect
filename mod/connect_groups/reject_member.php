<?php
        ...
        $template_file = dirname(dirname(dirname(__FILE__))) . "/mod/connect_groups/templates/reject_member";
        ...
        {
                $area2 .= elgg_view('groups/reject_member',array('user' => $user, 'entity' => $group, 'template' => $templatedata));
