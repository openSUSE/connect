...
<head>
	...
	<script type="text/javascript" src="<?php echo $vars['url'];?>mod/elgg-maps/vendors/jquery/jquery-ui-1.8.11.custom.min.js"></script>
	<script type="text/javascript" src="<?php echo $vars['url'];?>mod/elgg-maps/vendors/jquery/jquery.form.js"></script>
