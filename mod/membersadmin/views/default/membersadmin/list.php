<?php
  ...
  $form_body .= '<tr><td colspan="4">';
  $form_body .= '<p>If you paste the list of IRC nicks into the following field and submit the form, all nicks in the list will have their cloak flag set to applied. Don\'t forget to turn off the Javascript TinyMCE editor before submitting!</p>';
  $form_body .= elgg_view('input/longtext', array('internalname' => 'applylist', 'value' => '')) . '</td></tr>';
  $form_body .= "</table>\n";
